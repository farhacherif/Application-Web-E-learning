...
public class Session {
	...
	/*
	 * public Session(Long id, @NotBlank(message = "Lieu ne doit pas être vide ")
	 * String lieu,
	 * 
	 * @NotBlank(message = "Nombre de participant ne doit pas être vide ") int
	 * nb_participant,
	 * 
	 * @NotBlank(message = "Date debut ne doit pas être vide ") Date date_debut,
	 * 
	 * @NotBlank(message = "Date fin ne doit pas être vide ") Date date_fin,
	 * Formateur formateur) { super(); this.id = id; this.lieu = lieu;
	 * this.nb_participant = nb_participant; this.date_debut = date_debut;
	 * this.date_fin = date_fin; this.formateur = formateur; }
	 */
