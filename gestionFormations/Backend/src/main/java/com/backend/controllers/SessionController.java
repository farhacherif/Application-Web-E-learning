...
public class SessionController {
    ...
    public Session createSession(@PathVariable(value= "formateurId") Long formateurId, @RequestBody sessionRequest sessionRequest) {
    	return formateurRepo.findById(formateurId).map(formateur -> {
    		Session session = new Session(
    				sessionRequest.getLieu(),
    				sessionRequest.getNb_participant(),
    				sessionRequest.getDate_debut(),
    				sessionRequest.getDate_fin(),
